...
public class MainMenu : MonoBehaviour {
    ...
    private void RepositionVolumeContainer() {
        mvButton.transform.parent.gameObject.transform.Translate(new Vector3(24f, -24f, 0));
        mvButton.transform.parent.gameObject.transform.localScale = new Vector2(1.25f, 1.25f);

        accountButton.transform.parent.gameObject.transform.Translate(new Vector3(-24f, -24f, 0));
